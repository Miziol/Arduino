		...
		default:
			switch(button)
			{
				...
				case Two:
					...
					break;
				case Three:
					SR_data = (SR_data & 0b11111011) + ((SR_data + 4) & 0x04);
					break;
				case Four:
					SR_data = (SR_data & 0b11110111) + ((SR_data + 8) & 0x08);
					break;
				case Five:
					SR_data = (SR_data & 0b11101111) + ((SR_data + 16) & 0x10);
					break;
				case Six:
					SR_data = (SR_data & 0b11011111) + ((SR_data + 32) & 0x20);
					break;
				case Seven:
					SR_data = (SR_data & 0b10111111) + ((SR_data + 64) & 0x40);
					break;
				case Eight:
					SR_data = (SR_data & 0b01111111) + ((SR_data + 128) & 0x80);
					break;
				case Nine:
					SR_data = 0x00;
					break;
